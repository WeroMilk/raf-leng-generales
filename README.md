# RAF Lenguaje — Secundarias Generales

Aplicación Next.js para visualizar resultados del examen diagnóstico RAF Lenguaje de **Secundarias Generales**, Hermosillo, Sonora.
...
- **Despegue 2025:** `data/excel/despegue-2025/*_actualizado.xlsx`
- **Aterrizaje 2026:** `data/excel/aterrizaje-2026/`
3. Generar JSON:
