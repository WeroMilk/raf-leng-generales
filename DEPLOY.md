# Despliegue en Vercel — RAF Lenguaje | E.S.G.

Proyecto: **Secundarias Generales** (Lenguaje)

Repositorio sugerido: `WeroMilk/raf-leng-generales`
...
Editar `lib/raf-config.json` → campo `cctPrefix` cuando conozcas el prefijo oficial de Secundarias Generales.
